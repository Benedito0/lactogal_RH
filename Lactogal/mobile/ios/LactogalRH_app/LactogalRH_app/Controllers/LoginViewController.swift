...
class LoginViewController: UIViewController {
    ...
    let loginButton: UIButton =
    {
        ...
        param.backgroundColor = UIColor(red:2/255, green:23/255, blue:68/255, alpha:0.7)
    ...
    let is_not_registered_button: UIButton =
    {
        ...
        attributedText.append(NSMutableAttributedString(string: " Cadastre-se", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 14), NSAttributedString.Key.foregroundColor: UIColor(red:2/255, green:23/255, blue:68/255, alpha:0.7)]))
    ...
    @objc func handleTextInputChange()
    {
        ...
        if formValid
        {
            ...
            loginButton.backgroundColor = UIColor(red:2/255, green:23/255, blue:68/255, alpha:1)
        }else
        {
            loginButton.backgroundColor = UIColor(red:2/255, green:23/255, blue:68/255, alpha:0.7)
        }
    ...
    {
        logo_label.topAnchor.constraint(equalTo: view.topAnchor, constant: 40).isActive = true
        logo_label.centerXAnchor.constraint(equalTo: view.centerXAnchor).isActive = true
        logo_label.heightAnchor.constraint(equalToConstant: 170).isActive = true
